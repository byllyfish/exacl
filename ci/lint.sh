...
IGNORE="similar-names wildcard_imports use_self module_name_repetitions needless_raw_string_hashes unnecessary_debug_formatting used_underscore_items elidable_lifetime_names needless_lifetimes"
